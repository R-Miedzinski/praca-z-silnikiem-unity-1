...
{
  [Tooltip("Effects associated with this ItemEffect. Contains the effect ID and parameters for that effect")]
  ...
  [Tooltip("If true, activating this effect toggles it on/off. Requires all effects to implement IPersistentEffect. Not compatible with projectile targeting.")]
